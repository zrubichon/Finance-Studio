export const navItems = [
  ...
  { slug: "news", label: "News & Analysis", icon: "◎" },
  { slug: "university", label: "Finance University", icon: "◫" },
  { slug: "careers", label: "Careers", icon: "◇" },
  { slug: "interview", label: "Interview Studio", icon: "◌" },
  { slug: "investing", label: "Investing Lab", icon: "△" },
  { slug: "professor", label: "AI Professor", icon: "✦" },
  { slug: "dictionary", label: "Dictionary", icon: "Aa" },
  { slug: "progress", label: "Progress", icon: "◔" },
  { slug: "themes", label: "Theme Studio", icon: "◉" },
] as const;
